...
def main():
    print("Processing alumnos_cleaned.csv to replace inequalities with fraction solutions...")
    ...
    for i, line in enumerate(lines):
        ...
        elif i > 119:  # Only process up to row 119
            processed_lines.append(line.rstrip('\n'))
    ...
    print("Successfully replaced mathematical inequalities with fraction solutions!")
    print(f"Modified {len(processed_lines) - 2} student records (rows 3-119)")
    ...
    for i in range(2, min(6, len(processed_lines))):  # Show rows 3-5
        ...
        if len(row_data) >= 5:
            ...
            for k, var in enumerate(variables):
                col_index = k + 5  # Columns 6-15 are indices 5-14
