...
def main():
    ...
    print("Testing inequality solver with fraction output:")
    ...
    with open('alumnos_fraction_solutions.csv', 'w', newline='', encoding='utf-8') as file:
    ...
    print(f"\nCreated alumnos_fraction_solutions.csv with {len(solutions)} student records")
    print("All solutions are now in simplified fraction form!")
